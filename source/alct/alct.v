...
// Apply Error Correcting Code bits to trigger-path data from ALCT
  ...
  .error    (ecc_err[1:0]));    // Out  Error code: 0=no errors, 1=corrected 1-bit error, 2=double-bit error, 3=other error
...
// ECC error detect for signals from TMB
  ...
  .parity_out  (parity_out[5:0]));    // Out  ECC parity for input data
