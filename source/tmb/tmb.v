...
// Find highest priority window position that has a non-tagged clct
  ...
  assign {pri_s0[7],win_s0[7]} = (win_pri[15] > win_pri_14 ? {win_pri_15,1'b1} : {win_pri_14,1'b0};
  assign {pri_s0[6],win_s0[6]} = (win_pri[13] > win_pri_12 ? {win_pri_13,1'b1} : {win_pri_12,1'b0};
  assign {pri_s0[5],win_s0[5]} = (win_pri[11] > win_pri_10 ? {win_pri_11,1'b1} : {win_pri_10,1'b0};
  assign {pri_s0[4],win_s0[4]} = (win_pri[ 9] > win_pri_8  ? {win_pri_9 ,1'b1} : {win_pri_8 ,1'b0};
  assign {pri_s0[3],win_s0[3]} = (win_pri[ 7] > win_pri_6  ? {win_pri_7 ,1'b1} : {win_pri_6 ,1'b0};
  assign {pri_s0[2],win_s0[2]} = (win_pri[ 5] > win_pri_4  ? {win_pri_5 ,1'b1} : {win_pri_4 ,1'b0};
  assign {pri_s0[1],win_s0[1]} = (win_pri[ 3] > win_pri_2  ? {win_pri_3 ,1'b1} : {win_pri_2 ,1'b0};
  assign {pri_s0[0],win_s0[0]} = (win_pri[ 1] > win_pri_0  ? {win_pri_1 ,1'b1} : {win_pri_0 ,1'b0};
  ...
  wire clct_pri_win_best = pri_win_best(win_pri[ 0],
                                        win_pri[ 1],
                                        win_pri[ 2],
                                        win_pri[ 3],
                                        win_pri[ 4],
